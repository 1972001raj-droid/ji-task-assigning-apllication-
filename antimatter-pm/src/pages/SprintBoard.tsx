...
import { statusLabel, statusDotColor } from '../lib/utils';
        ...
        <div className="flex gap-4 overflow-x-auto pb-4 flex-1 items-start min-h-0">
          {COLUMNS.map((col) => {
            ...
            return (
              <div
                key={col}
                className="w-72 shrink-0 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-slate-50/60 dark:bg-slate-900/40 p-3 flex flex-col max-h-full shadow-sm"
              >
